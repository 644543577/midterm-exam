...
Article_Description<- html |> 
  html_elements(".css-1l4spti") |>
  html_text2()
Article_Description

# Below is what I believe might be the correct answer, but I am encountering 
# difficulties in attempting to extract the "article description." Despite 
# multiple validations of my selector's correctness, its output still shows 
# as "character(0)". The above might be the answer you need.
...
df <- data.frame(Article_Name = Article_Name,
